...
class AnonymizationControllerTest {
    ...
    void anonymization_check_for_metric_values(){
        ...
        Assertions.assertEquals(0, actual.getAttributeGeneralization().get(0).getGeneralizationLevel());
        Assertions.assertEquals("gender", actual.getAttributeGeneralization().get(0).getName());
        Assertions.assertEquals("QUASI_IDENTIFYING_ATTRIBUTE", actual.getAttributeGeneralization().get(0).getType());
    }
}