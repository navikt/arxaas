...
public class ARXConfigurationFactory implements ConfigurationFactory {
    ...
    /***
     * Mutates ARX {@link ARXConfiguration} object by setting the suppression limit configuration for arxaas.
     * @param config an ARX {@link ARXConfiguration} object that holds the arxaas/data set settings
     * @param suppressionLimit a Double containing a value to be set as the suppression limit
     */
